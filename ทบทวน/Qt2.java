        ...
        if(con == 'f' || con == 'c' && con2 == 'f' || con2 == 'c'){
            if(con == 'f' || con2 == 'f'){
                if (con == 'f' && con2 == 'f'){
                    ...
                    num4 = (num4 + num3) * 2.54;
                    if(num2 > num4){
                        System.out.println("No. 1 is "+num2+" cm and No. 2 is "+num4+" cm.");
                    ...
                    num2 = (num2 + num1) * 2.54;
                    if(num2 > num3){
                        System.out.println("No. 1 is "+num2+" cm and No. 2 is "+num3+" cm.");
                        System.out.println("No. 1 is taller");
                    }else if(num3 > num2){
                        System.out.println("No. 1 is "+num2+" cm and No. 2 is "+num3+" cm.");
                        System.out.println("No. 2 is taller");
                    ...
                    num4 = (num4 + num3) * 2.54;
                    if(num4 > num1){
                        System.out.println("No. 1 is "+num4+" cm and No. 2 is "+num1+" cm.");
                        System.out.println("No. 1 is taller");
                    }else if(num1 > num4){
                        System.out.println("No. 1 is "+num4+" cm and No. 2 is "+num1+" cm.");
                        System.out.println("No. 2 is taller");
                ...
                if(num1 > num3){
                    System.out.println("No. 1 is "+num1+" cm and No. 2 is "+num3+" cm.");
                    System.out.println("No. 1 is taller");
                }else if(num3 > num1){
                    System.out.println("No. 1 is "+num1+" cm and No. 2 is "+num3+" cm.");
                    System.out.println("No. 2 is taller");
